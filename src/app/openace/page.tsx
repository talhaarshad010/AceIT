    ...
    >
      ...
      <div className={styles.contentContainerColumn}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ textAlign: "center" }} className={styles.text1}>
        ...
        >
          ...
          >
            ...
            <div className={`${styles.infoCards} ${styles.top}`}>
              <div className={styles.heading3}>
          ...
          >
            ...
            <div className={`${styles.infoCards} ${styles.bottom}`}>
              <div className={styles.heading3}>
                Cost-
      ...
      >
        ...
        <div className={styles.formContainer}>
          ...
          <div className={styles.inputItem}>
            <button className={styles.contactCard}>Submit</button>
          </div>
        </div>
      </div>
    </div>
