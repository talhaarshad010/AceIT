  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={styles.mobColumn} style={{ marginTop: "1.5vw" }}>
            <div
        ...
        >
          ...
          >
            ...
            >
              ...
              leverages AI, ML, and predictive
              <br /> analytics. It automates incident triage, assigns tasks, and
              suggests resolutions for rapid response.
            </div>
            ...
            >
              ...
              production and non-production environments, ensuring
              <br /> controlled access based on role-based policies.
            </div>
          </div>
          ...
          <div>
            <Image
              ...
              height={639}
              src={"/dispatch.png"}
              style={{ width: "80vw", height: "auto", marginTop: "2.5vw" }}
            />
          </div>
          ...
          >
            ...
            <div className={styles.alignwidth}>
              <div
                className={`${styles.heading1}  `}
                style={{
                  color: "#8fd5cc",
      ...
      >
        ...
        >
          ...
          <div
            className={` ${styles.containerSpacing}  ${styles.flexRow}  ${styles.alignCenter}`}
          >
            <div>
              <Image
                alt="dash"
            ...
            <div className={styles.contentCard}>
              ...
              <div className={styles.text1} style={{ color: "#000" }}>
                Streamline Your Incident Management with Ace8
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className={styles.mobColumn}>
              ...
              >
                <span style={{ fontWeight: "300" }}>Understanding</span> <br />
              ...
              >
                ...
                followed to
                <br />
                achieve a specific goal. In incident management, workflows are
                essential for
                <br /> processing data and ensuring smooth progression from one
                step/task to
                <br /> another. Without the movement of data, a workflow does
                not exist.
              </div>
          ...
          >
            ...
            <div className={styles.mobColumn}>
              ...
              >
                ...
                involves detecting <br /> incidents, communicating them to
                stakeholders, and utilizing appropriate
                <br /> tools to resolve them.
              </div>
