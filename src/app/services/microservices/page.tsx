  ...
  return (
    ...
    >
          ...
          <div className={styles.flexRow}>
            <div style={{ marginTop: "2vw" }}>
              ...
              <div className={`${styles.heading1}  ${styles.headingmin}`}>
                ...
                <span style={{ fontWeight: "lighter" }}>With Golang </span>
                Starter Kits
              </div>
              <div>
                {" "}
      ...
      >
        ...
        {isMobile ? (
          ...
          >
            ...
            >
              ...
              complexities of microservices architecture. If you&apos;re
        ...
        <ContactForm containerStyles={{ position: "relative", top: "-8vw" }} />
      </motion.div>
    </div>
  );
};
