      ...
      >
        <div className={styles.headerContentContainer}>
          <span className={styles.head1}>
            ...
            Onboarding as as Service (OBaaS)
            <br />
          </span>
        </div>
        ...
        <div className={styles.contentContainerColumn}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                <span style={{ fontWeight: "lighter" }}>
                  for Swift, Customized
                </span>{" "}
                Onboarding
              </div>
              <div className={styles.text1}>
                Enter a solution-oriented approach! We advocate for &quot;dev
                containers&quot; to seamlessly connect developers to cloud
                environments within hours, not weeks. This revolutionary method
                customizes dev-containers to fit the specific roles of your
                developers, ensuring rapid onboarding and substantial cost
                savings.
              </div>
              {/* Cards small */}

              <div style={{ marginTop: "2vw" }} className={styles.flexRow}>
                <div className={styles.infoCards}>
                  <div className={styles.heading3}>
                    <span style={{ fontWeight: "lighter" }}>Customized</span>{" "}
                    Dev-Containers:
                  </div>
                ...
                <div className={styles.infoCards}>
                  <div className={styles.heading3}>
                    Fast and{" "}
                    <span style={{ fontWeight: "lighter" }}>Painless</span>{" "}
                    Onboarding
                  </div>
                  <div className={styles.text2}>
          ...
          <div style={{ marginTop: "2vw" }} className={styles.flexRow}>
            <div className={styles.infoCards}>
              <div className={styles.heading3}>
                {" "}
                <span style={{ fontWeight: "lighter" }}>SecOps</span>
                -Vetted Tooling:
              </div>
              <div className={styles.text2}>
            ...
            <div style={{ width: "19vw" }} className={styles.infoCards}>
              <div className={styles.heading3}>
                Integration with
            ...
            <div className={styles.infoCards}>
              <div className={styles.heading3}>
                Fully <span style={{ fontWeight: "lighter" }}> Managed </span>{" "}
                Service
              </div>
              <div className={styles.text2}>
          ...
          >
            Why <span style={{ fontWeight: "lighter" }}>Choose </span>
            <span style={{ color: colors.primary }}> OBaaS</span> for{" "}
            <span style={{ fontWeight: "lighter" }}>Developer </span>
            Onboarding?
            <br />
          </div>
          <Image
            ...
            {ObaasCards.map((item, index) => {
              return (
                <div key={item.id} className={styles.obaasCard}>
                  ...
                  <div style={{ marginLeft: "4vw" }} className={styles.text2}>
          ...
          <div className={styles.infoText}>
            ...
            reduce idle time, and witness immediate productivity gains. Choose
            OBaaS for a customized, fully managed, and swift onboarding
            experience.
          </div>
        </div>
      </motion.div>
